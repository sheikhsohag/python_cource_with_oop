...
class Rider(User):
    ...
    def requenst_ride(self,ride_sharing, destination):
        if not self.current_ride:
            print('just check', ride_sharing)
           
            ride_request = Ride_Requent(self,destination)
